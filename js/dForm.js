(function ($) {
    /*
     *  get class name for each kind of element
     *
     *  @param string idName
     * */
        ...
        $('#your_dForm').live('submit', function () {
            ...
            $('#your_dForm .lef_label').each(function () {
                ...
                if ($(this).hasClass('matrix_l')) {
                    ...
                    var pname = $(this).parent().find('.dataMatrix').attr('name');
                    text_edit.push([name_, data_, text_edit_, pname]);
                }
                else {
    ...
    function gen_html_Matrix(dataRows, dataColumns, name_input, type_) {
        ...
        html_ += '<table cellspacing="0" cellpadding="4" width="60%" class="dataMatrix" name="matrix_' + name_input + '"><tr><th style="border:none">&nbsp;</th>';
